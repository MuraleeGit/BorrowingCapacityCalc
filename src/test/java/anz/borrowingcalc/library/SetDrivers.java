...
public class SetDrivers {
	...
	public WebDriver setDrivers(String browser) {
		...
		if (browser.equals("firefox")) {
			System.setProperty("webdriver.gecko.driver", "./src/test/java/anz/borrowingcalc/drivers/geckodriver.exe");
			driver = new FirefoxDriver();
		} else {
			System.setProperty("webdriver.chrome.driver", "./src/test/java/anz/borrowingcalc/drivers/chromedriver.exe");
